...
<body>
    ...
    <section class="cont_inicial2">
        <header class="cont_menu-2">
                        <button class="btn-menu-2"><a href="../edicion/edit_servicio.php">
                            <img class="img_btn" src="../Imagenes/edit.png" alt="">Edit Service</a>
                        </button>
            
        </header>
        <section class="contenedor">
            
               <form action="../registrar/registrar_5.php" method="post"  class="form_registro">
