...
error_reporting(0);
    ...
    $operadores = "select id_operario, nomb_operario, apell_operario, cargos.nomb_cargo 
    from operarios
    inner join cargos
...
<body>
    ...
    <section class="cont_inicial2">
        <header class="cont_menu-2">
            <button class="btn-menu-2"><a href="../edicion/edit_operario.php">
                <img class="img_btn" src="../imagenes/edit.png" alt="">Edit Operators</a>
            </button>
        </header>
        <section class="contenedor">
            
               <form action="../registrar/registrar_4.php" method="post"  class="form_registro">
               ...
               <main class="cont-box-n">
                <header class="t_head">
                  ...
                  <button class="btn-3">Name </button>
                  <button class="btn-3">Last Name</button>
...
?>
                   <tr>
                        ...
                        <td class="td-1"><?php echo $row["nomb_operario"] ?></td>
                        <td class="td-1"><?php echo $row["apell_operario"] ?></td>
