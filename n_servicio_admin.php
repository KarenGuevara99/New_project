...
<body>
    ...
    <section class="cont_inicial2">
            <header class="cont_menu-2">
                <button class="btn-menu-2"><a href="admin_clientes.php">
                ...
                <button class="btn-menu-2"><a href="admin_operadores.php">
                    <img class="img_btn" src="./Imagenes/operator.png" alt="">Admin. Operators</a>
                </button>
                <button class="btn-menu-2"><a href="admin_servicios.php">
                    <img class="img_btn" src="./Imagenes/servicios.png" alt="">Admin. Services</a>
                </button>
            </header>
            <section class="contenedor">

                   <form action="Connection/registrar_7.php" method="post" 
                        class="form_registro">
